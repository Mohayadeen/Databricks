...
# MAGIC   source = "wasbs://frequent@ecommercestore.blob.core.windows.net/",
# MAGIC   mountPoint = "/mnt/frequent",
# MAGIC   extraConfigs = Map("fs.azure.account.key.ecommercestore.blob.core.windows.net" -> "l4Hy0A4h4TM+HX9bF+a9xw9l7u/1wG9nTI07seeaNBRz9H59tcLSx62flt0LW8Hm0Rs/3iNDD+apY70VOKbexw=="))
